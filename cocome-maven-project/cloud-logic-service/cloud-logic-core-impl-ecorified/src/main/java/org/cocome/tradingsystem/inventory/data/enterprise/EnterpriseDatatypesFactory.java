...
@Dependent
public
class EnterpriseDatatypesFactory extends unification.org.cocome.tradingsystem.inventory.data.enterprise.UnifiedEnterpriseDatatypesFactory implements IEnterpriseDataFactory {
	...
	public IProduct getNewProduct() {
		return getProductProvider().get();
	}
	
	
	Provider<TradingEnterprise> getEnterpriseProvider() {
		return enterpriseProvider;
	}


	void setEnterpriseProvider(Provider<TradingEnterprise> enterpriseProvider) {
		this.enterpriseProvider = enterpriseProvider;
	}


	Provider<ProductSupplier> getProductSupplierProvider() {
		return productSupplierProvider;
	}


	void setProductSupplierProvider(Provider<ProductSupplier> productSupplierProvider) {
		this.productSupplierProvider = productSupplierProvider;
	}


	Provider<Product> getProductProvider() {
		return productProvider;
	}


	void setProductProvider(Provider<Product> productProvider) {
	...
	public IProductSupplier getNewProductSupplier() {
		return getProductSupplierProvider().get();
	}
	...
	public ITradingEnterprise getNewTradingEnterprise() {
		return getEnterpriseProvider().get();
	}
