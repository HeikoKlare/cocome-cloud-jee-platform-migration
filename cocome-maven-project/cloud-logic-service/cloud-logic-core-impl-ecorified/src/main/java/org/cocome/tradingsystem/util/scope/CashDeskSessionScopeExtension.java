 ...
 *
 */
public class CashDeskSessionScopeExtension extends unification.org.cocome.tradingsystem.util.scope.UnifiedCashDeskSessionScopeExtension implements Extension, Serializable {
	...
	private static void setSerialVersionUID(long serialVersionUID) {
		CashDeskSessionScopeExtension.serialVersionUID = serialVersionUID;
	}
