 ...
 */
public class ServiceAdapterEntityConverter extends unification.org.cocome.tradingsystem.inventory.data.persistence.UnifiedServiceAdapterEntityConverter {
	...
	public static String getStockItemContent(IStockItem stockItem) {
		...
		content.append(ServiceAdapterHeaders.getSEPARATOR());
