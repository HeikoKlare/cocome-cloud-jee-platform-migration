 ...
 */
public class Reflection extends unification.org.cocome.tradingsystem.util.java.UnifiedReflection {
	...
	private static Comparator<Method> get__METHOD_COMPARATOR__() {
		return __METHOD_COMPARATOR__;
	}

	private static void set__METHOD_COMPARATOR__(Comparator<Method> __METHOD_COMPARATOR__) {
		Reflection.__METHOD_COMPARATOR__ = __METHOD_COMPARATOR__;
	}
	 ...
	 * structure.
	 */
	static final public class InheritanceChainIterable
	 ...
	 */
	static final public class DeclaredFieldsIterable
	 ...
	 */
	private static Comparator<Method> __METHOD_COMPARATOR__ =
	...
	public static void orderMethods(final List<Method> methods) {
		Collections.sort(methods, get__METHOD_COMPARATOR__());
	}
