 ...
 */
public class Iterables extends unification.org.cocome.tradingsystem.util.java.UnifiedIterables {
	...
	public static Iterator<?> getEMPTY_ITERATOR() {
		return EMPTY_ITERATOR;
	}

	public static void setEMPTY_ITERATOR(Iterator<?> eMPTY_ITERATOR) {
		EMPTY_ITERATOR = eMPTY_ITERATOR;
	}

	static abstract public class ImmutableIterator<T> implements Iterator<T> {
		@Override
	...
	private static Iterator<?> EMPTY_ITERATOR = new ImmutableIterator() {
		@Override
	...
	public static <E> Iterator<E> emptyIterator() {
		return (Iterator<E>) getEMPTY_ITERATOR();
	}
	...
	static final public class FilteringIterator<E> implements Iterator<E> {
	...
	static final public class ArrayIterator<E> implements Iterator<E> {
	...
	static public class RandomSampler<E> extends ImmutableIterator<E> {
	...
	static final public class RandomIterator<E> extends RandomSampler<E> {
