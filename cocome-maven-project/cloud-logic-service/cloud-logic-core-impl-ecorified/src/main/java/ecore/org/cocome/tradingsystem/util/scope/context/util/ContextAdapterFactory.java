...
public class ContextAdapterFactory extends AdapterFactoryImpl {
	...
	protected ContextSwitch<Adapter> modelSwitch =
		new ContextSwitch<Adapter>() {
			@Override
			public Adapter caseNamedSessionContext(NamedSessionContext object) {
				return createNamedSessionContextAdapter();
			}
			@Override
			public Adapter caseNamedSessionContextHolder(NamedSessionContextHolder object) {
				return createNamedSessionContextHolderAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecore.org.cocome.tradingsystem.util.scope.context.NamedSessionContext <em>Named Session Context</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNamedSessionContextAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ecore.org.cocome.tradingsystem.util.scope.context.NamedSessionContextHolder <em>Named Session Context Holder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNamedSessionContextHolderAdapter() {
		return null;
	}
