/**
 */
package ecore.datatypes.org.cocome.tradingsystem.inventory.application.usermanager.credentials.impl;
...
import ecore.datatypes.org.cocome.tradingsystem.inventory.application.usermanager.credentials.CredentialsFactoryOld;
 ...
 * @generated
 */
public class CredentialsPackageImpl extends EPackageImpl implements CredentialsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType iCredentialEDataType = null;
	 ...
	 * @see ecore.datatypes.org.cocome.tradingsystem.inventory.application.usermanager.credentials.CredentialsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CredentialsPackageImpl() {
		super(eNS_URI, CredentialsFactoryOld.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link CredentialsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CredentialsPackage init() {
		if (isInited) return (CredentialsPackage)EPackage.Registry.INSTANCE.getEPackage(CredentialsPackage.eNS_URI);

		// Obtain or create and register package
		CredentialsPackageImpl theCredentialsPackage = (CredentialsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CredentialsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CredentialsPackageImpl());
		...
		theCredentialsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CredentialsPackage.eNS_URI, theCredentialsPackage);
		return theCredentialsPackage;
	}
	 ...
	 * @generated
	 */
	public EDataType getICredential() {
		return iCredentialEDataType;
	}
	 ...
	 * @generated
	 */
	public CredentialsFactoryOld getCredentialsFactory() {
		return (CredentialsFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		iCredentialEDataType = createEDataType(ICREDENTIAL);
	}
	...
	public void initializePackageContents() {
		...
		initEDataType(iCredentialEDataType, ICredential.class, "ICredential", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}

} //CredentialsPackageImpl
