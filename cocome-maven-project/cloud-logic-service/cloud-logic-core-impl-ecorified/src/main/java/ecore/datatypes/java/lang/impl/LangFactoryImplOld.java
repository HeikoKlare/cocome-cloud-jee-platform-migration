...
public class LangFactoryImplOld extends EFactoryImpl implements LangFactoryOld {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case LangPackage.THREAD_LOCAL:
				return createThreadLocalFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case LangPackage.THREAD_LOCAL:
				return convertThreadLocalToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ThreadLocal<?> createThreadLocalFromString(EDataType eDataType, String initialValue) {
		return (ThreadLocal<?>)super.createFromString(initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertThreadLocalToString(EDataType eDataType, Object instanceValue) {
