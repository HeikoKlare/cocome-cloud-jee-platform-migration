...
public class UsermanagerPackageImpl extends EPackageImpl implements UsermanagerPackage {
	 ...
	 * @generated
	 */
	private EDataType credentialTOEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType credentialTypeEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType credentialTypeNotFoundExceptionEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType userTOEDataType = null;
	 ...
	 * @see ecore.datatypes.org.cocome.tradingsystem.inventory.application.usermanager.UsermanagerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UsermanagerPackageImpl() {
		super(eNS_URI, UsermanagerFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public EDataType getCredentialTO() {
		return credentialTOEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getCredentialType() {
		return credentialTypeEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getCredentialTypeNotFoundException() {
		return credentialTypeNotFoundExceptionEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getUserTO() {
		return userTOEDataType;
	}
	 ...
	 * @generated
	 */
	public UsermanagerFactoryOld getUsermanagerFactory() {
		return (UsermanagerFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		credentialTOEDataType = createEDataType(CREDENTIAL_TO);
		credentialTypeEDataType = createEDataType(CREDENTIAL_TYPE);
		credentialTypeNotFoundExceptionEDataType = createEDataType(CREDENTIAL_TYPE_NOT_FOUND_EXCEPTION);
		roleEDataType = createEDataType(ROLE);
		userTOEDataType = createEDataType(USER_TO);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theCredentialsPackage);

		// Initialize data types
		initEDataType(credentialTOEDataType, CredentialTO.class, "CredentialTO", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(credentialTypeEDataType, CredentialType.class, "CredentialType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(credentialTypeNotFoundExceptionEDataType, CredentialTypeNotFoundException.class, "CredentialTypeNotFoundException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(roleEDataType, Role.class, "Role", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(userTOEDataType, UserTO.class, "UserTO", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
