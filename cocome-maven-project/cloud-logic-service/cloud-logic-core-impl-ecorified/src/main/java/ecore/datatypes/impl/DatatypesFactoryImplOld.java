 ...
 * @generated
 */
public class DatatypesFactoryImplOld extends EFactoryImpl implements DatatypesFactoryOld {
	/**
	 ...
	 * @generated
	 */
	public static DatatypesFactoryOld init() {
		return new DatatypesFactoryImplOld();
	}
	 ...
	 * @generated
	 */
	public DatatypesFactoryImplOld() {
		super();
	}
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DatatypesPackage.LONG_ARRAY:
