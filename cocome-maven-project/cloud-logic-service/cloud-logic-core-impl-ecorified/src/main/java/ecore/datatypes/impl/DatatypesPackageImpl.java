...
import ecore.datatypes.DatatypesFactoryOld;
...
public class DatatypesPackageImpl extends EPackageImpl implements DatatypesPackage {
	 ...
	 * @see ecore.datatypes.DatatypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DatatypesPackageImpl() {
		super(eNS_URI, DatatypesFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public DatatypesFactoryOld getDatatypesFactory() {
		return (DatatypesFactoryOld)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		UsermanagerPackage theUsermanagerPackage = (UsermanagerPackage)EPackage.Registry.INSTANCE.getEPackage(UsermanagerPackage.eNS_URI);
		...
		getESubpackages().add(theEjbPackage);
		getESubpackages().add(theContextPackage);
		getESubpackages().add(theInjectPackage);
		getESubpackages().add(theStorePackage);
		getESubpackages().add(theUsermanagerPackage);
		getESubpackages().add(theEnterprisePackage);
		getESubpackages().add(thePersistencePackage);
		getESubpackages().add(theStorePackage_1);
		getESubpackages().add(theUsermanagerPackage_1);
