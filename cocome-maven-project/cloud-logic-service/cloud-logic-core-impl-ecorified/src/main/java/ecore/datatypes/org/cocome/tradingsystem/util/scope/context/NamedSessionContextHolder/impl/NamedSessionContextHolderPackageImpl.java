 ...
 * @generated
 */
public class NamedSessionContextHolderPackageImpl extends EPackageImpl implements NamedSessionContextHolderPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType namedSessionInstanceEDataType = null;
	 ...
	 * @see ecore.datatypes.org.cocome.tradingsystem.util.scope.context.NamedSessionContextHolder.NamedSessionContextHolderPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NamedSessionContextHolderPackageImpl() {
		super(eNS_URI, NamedSessionContextHolderFactoryOld.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link NamedSessionContextHolderPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NamedSessionContextHolderPackage init() {
		if (isInited) return (NamedSessionContextHolderPackage)EPackage.Registry.INSTANCE.getEPackage(NamedSessionContextHolderPackage.eNS_URI);

		// Obtain or create and register package
		NamedSessionContextHolderPackageImpl theNamedSessionContextHolderPackage = (NamedSessionContextHolderPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof NamedSessionContextHolderPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new NamedSessionContextHolderPackageImpl());
		...
		theNamedSessionContextHolderPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NamedSessionContextHolderPackage.eNS_URI, theNamedSessionContextHolderPackage);
		return theNamedSessionContextHolderPackage;
	}
	 ...
	 * @generated
	 */
	public EDataType getNamedSessionInstance() {
		return namedSessionInstanceEDataType;
	}
	 ...
	 * @generated
	 */
	public NamedSessionContextHolderFactoryOld getNamedSessionContextHolderFactory() {
		return (NamedSessionContextHolderFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		namedSessionInstanceEDataType = createEDataType(NAMED_SESSION_INSTANCE);
	}
	...
	public void initializePackageContents() {
		...
		initEDataType(namedSessionInstanceEDataType, NamedSessionInstance.class, "NamedSessionInstance", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
