/**
 */
package ecore.datatypes.org.cocome.tradingsystem.util.scope.impl;
...
import ecore.datatypes.org.cocome.tradingsystem.util.scope.ScopeFactoryOld;
...
public class ScopePackageImpl extends EPackageImpl implements ScopePackage {
	 ...
	 * @generated
	 */
	private EDataType iContextRegistryEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType registryKeysEDataType = null;
	 ...
	 * @see ecore.datatypes.org.cocome.tradingsystem.util.scope.ScopePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ScopePackageImpl() {
		super(eNS_URI, ScopeFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public EDataType getIContextRegistry() {
		return iContextRegistryEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getRegistryKeys() {
		return registryKeysEDataType;
	}
	 ...
	 * @generated
	 */
	public ScopeFactoryOld getScopeFactory() {
		return (ScopeFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		iContextRegistryEDataType = createEDataType(ICONTEXT_REGISTRY);
		registryKeysEDataType = createEDataType(REGISTRY_KEYS);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theNamedSessionContextHolderPackage);

		// Initialize data types
		initEDataType(iContextRegistryEDataType, IContextRegistry.class, "IContextRegistry", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(registryKeysEDataType, RegistryKeys.class, "RegistryKeys", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
