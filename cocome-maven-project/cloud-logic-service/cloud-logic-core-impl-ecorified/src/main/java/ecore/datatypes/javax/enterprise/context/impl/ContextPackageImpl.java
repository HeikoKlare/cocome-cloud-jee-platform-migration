/**
 */
package ecore.datatypes.javax.enterprise.context.impl;
...
import ecore.datatypes.javax.enterprise.context.ContextFactoryOld;
...
public class ContextPackageImpl extends EPackageImpl implements ContextPackage {
	 ...
	 * @generated
	 */
	private EDataType contextNotActiveExceptionEDataType = null;
	 ...
	 * @see ecore.datatypes.javax.enterprise.context.ContextPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ContextPackageImpl() {
		super(eNS_URI, ContextFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public EDataType getContextNotActiveException() {
		return contextNotActiveExceptionEDataType;
	}
	 ...
	 * @generated
	 */
	public ContextFactoryOld getContextFactory() {
		return (ContextFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		contextNotActiveExceptionEDataType = createEDataType(CONTEXT_NOT_ACTIVE_EXCEPTION);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theSpiPackage);

		// Initialize data types
		initEDataType(contextNotActiveExceptionEDataType, ContextNotActiveException.class, "ContextNotActiveException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
