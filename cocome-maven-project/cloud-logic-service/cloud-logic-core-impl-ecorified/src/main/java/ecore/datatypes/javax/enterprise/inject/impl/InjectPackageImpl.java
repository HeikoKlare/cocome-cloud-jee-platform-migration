/**
 */
package ecore.datatypes.javax.enterprise.inject.impl;
...
import ecore.datatypes.javax.enterprise.inject.InjectFactoryOld;
 ...
 * @generated
 */
public class InjectPackageImpl extends EPackageImpl implements InjectPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType instanceEDataType = null;
	 ...
	 * @see ecore.datatypes.javax.enterprise.inject.InjectPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InjectPackageImpl() {
		super(eNS_URI, InjectFactoryOld.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link InjectPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static InjectPackage init() {
		if (isInited) return (InjectPackage)EPackage.Registry.INSTANCE.getEPackage(InjectPackage.eNS_URI);

		// Obtain or create and register package
		InjectPackageImpl theInjectPackage = (InjectPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InjectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InjectPackageImpl());
		...
		theInjectPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(InjectPackage.eNS_URI, theInjectPackage);
		return theInjectPackage;
	}
	 ...
	 * @generated
	 */
	public EDataType getInstance() {
		return instanceEDataType;
	}
	 ...
	 * @generated
	 */
	public InjectFactoryOld getInjectFactory() {
		return (InjectFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		instanceEDataType = createEDataType(INSTANCE);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theSpiPackage_1);

		// Initialize data types
		initEDataType(instanceEDataType, Instance.class, "Instance", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
