 ...
 * @generated
 */
public class IoFactoryImplOld extends EFactoryImpl implements IoFactoryOld {
	/**
	 ...
	 * @generated
	 */
	public static IoFactoryOld init() {
		return new IoFactoryImplOld();
	}
