...
public class LangPackageImpl extends EPackageImpl implements LangPackage {
	 ...
	 * @generated
	 */
	private EDataType threadLocalEDataType = null;
	 ...
	 * @generated
	 */
	public EDataType getThreadLocal() {
		return threadLocalEDataType;
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		threadLocalEDataType = createEDataType(THREAD_LOCAL);
	}
	...
	public void initializePackageContents() {
		...
		initEDataType(threadLocalEDataType, ThreadLocal.class, "ThreadLocal", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
