/**
 */
package ecore.datatypes.org.cocome.tradingsystem.util.exception.impl;
...
import ecore.datatypes.org.cocome.tradingsystem.util.exception.ExceptionFactoryOld;
...
public class ExceptionPackageImpl extends EPackageImpl implements ExceptionPackage {
	 ...
	 * @generated
	 */
	private EDataType notInDatabaseExceptionEDataType = null;
	 ...
	 * @see ecore.datatypes.org.cocome.tradingsystem.util.exception.ExceptionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ExceptionPackageImpl() {
		super(eNS_URI, ExceptionFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public EDataType getNotInDatabaseException() {
		return notInDatabaseExceptionEDataType;
	}
	 ...
	 * @generated
	 */
	public ExceptionFactoryOld getExceptionFactory() {
		return (ExceptionFactoryOld)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		notInDatabaseExceptionEDataType = createEDataType(NOT_IN_DATABASE_EXCEPTION);
	}
	...
	public void initializePackageContents() {
		...
		initEDataType(notInDatabaseExceptionEDataType, NotInDatabaseException.class, "NotInDatabaseException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}
