/**
 */
package ecore.datatypes.java.lang.annotation.impl;
...
import ecore.datatypes.java.lang.annotation.AnnotationFactoryOld;
...
public class AnnotationPackageImpl extends EPackageImpl implements AnnotationPackage {
	 ...
	 * @see ecore.datatypes.java.lang.annotation.AnnotationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AnnotationPackageImpl() {
		super(eNS_URI, AnnotationFactoryOld.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public AnnotationFactoryOld getAnnotationFactory() {
		return (AnnotationFactoryOld)getEFactoryInstance();
	}
