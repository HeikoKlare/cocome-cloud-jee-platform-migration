/**
 */
package ecore.datatypes.java.util.concurrent.impl;
...
import ecore.datatypes.java.util.concurrent.ConcurrentFactoryOld;
...
public class ConcurrentPackageImpl extends EPackageImpl implements ConcurrentPackage {
	 ...
	 * @see ecore.datatypes.java.util.concurrent.ConcurrentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ConcurrentPackageImpl() {
		super(eNS_URI, ConcurrentFactoryOld.eINSTANCE);
	}
	...
	public static ConcurrentPackage init() {
		...
		ConcurrentPackageImpl theConcurrentPackage = (ConcurrentPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ConcurrentPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ConcurrentPackageImpl());
	 ...
	 * @generated
	 */
	public ConcurrentFactoryOld getConcurrentFactory() {
		return (ConcurrentFactoryOld)getEFactoryInstance();
	}
