...
public class EcorePackageImpl extends EPackageImpl implements EcorePackage {
	...
	public void initializePackageContents() {
		...
		ecore.org.cocome.tradingsystem.inventory.data.persistence.PersistencePackage thePersistencePackage_1 = (ecore.org.cocome.tradingsystem.inventory.data.persistence.PersistencePackage)EPackage.Registry.INSTANCE.getEPackage(ecore.org.cocome.tradingsystem.inventory.data.persistence.PersistencePackage.eNS_URI);
		...
		ecore.org.cocome.tradingsystem.inventory.data.usermanager.UsermanagerPackage theUsermanagerPackage_2 = (ecore.org.cocome.tradingsystem.inventory.data.usermanager.UsermanagerPackage)EPackage.Registry.INSTANCE.getEPackage(ecore.org.cocome.tradingsystem.inventory.data.usermanager.UsermanagerPackage.eNS_URI);
		...
		ParsingPackage theParsingPackage = (ParsingPackage)EPackage.Registry.INSTANCE.getEPackage(ParsingPackage.eNS_URI);
		JavaPackage theJavaPackage = (JavaPackage)EPackage.Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI);
		ecore.org.cocome.tradingsystem.util.scope.ScopePackage theScopePackage_1 = (ecore.org.cocome.tradingsystem.util.scope.ScopePackage)EPackage.Registry.INSTANCE.getEPackage(ecore.org.cocome.tradingsystem.util.scope.ScopePackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theDatatypesPackage);
		getESubpackages().add(theEnterprisePackage_1);
		getESubpackages().add(thePersistencePackage_1);
		getESubpackages().add(theStorePackage_2);
		getESubpackages().add(theUsermanagerPackage_2);
		getESubpackages().add(theConnectionPackage);
		getESubpackages().add(theParsingPackage);
		getESubpackages().add(theJavaPackage);
		getESubpackages().add(theScopePackage_1);
