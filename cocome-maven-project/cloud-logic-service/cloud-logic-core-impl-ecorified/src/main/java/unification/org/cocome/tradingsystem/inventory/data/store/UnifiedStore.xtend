...
/**
 * Unification class for the class Store
 */
class UnifiedStore extends MinimalEObjectImpl.Container implements Store {
	
	@Delegate
	protected var Store ecoreImplementation
	...
	def protected Store getInstance() {
		return StoreFactoryOld.eINSTANCE.createStore
	}
}
