...
/**
 * Unification class for the class Sets
 */
class UnifiedSets extends MinimalEObjectImpl.Container implements Sets {
	
	@Delegate
	protected var Sets ecoreImplementation
	...
	def protected Sets getInstance() {
		return JavaFactoryOld.eINSTANCE.createSets
	}
}
