...
/**
 * Unification class for the class TradingEnterprise
 */
class UnifiedTradingEnterprise extends MinimalEObjectImpl.Container implements TradingEnterprise {
	
	@Delegate
	protected var TradingEnterprise ecoreImplementation
	...
	def protected TradingEnterprise getInstance() {
		return EnterpriseFactoryOld.eINSTANCE.createTradingEnterprise
	}
}
