...
/**
 * Unification class for the class CloudPersistenceContext
 */
class UnifiedCloudPersistenceContext extends MinimalEObjectImpl.Container implements CloudPersistenceContext {
	
	@Delegate
	protected var CloudPersistenceContext ecoreImplementation
	...
	def protected CloudPersistenceContext getInstance() {
		return PersistenceFactoryOld.eINSTANCE.createCloudPersistenceContext
	}
}
