...
/**
 * Unification class for the class MessageToCSV
 */
class UnifiedMessageToCSV extends MinimalEObjectImpl.Container implements MessageToCSV {
	
	@Delegate
	protected var MessageToCSV ecoreImplementation
	...
	def protected MessageToCSV getInstance() {
		return ParsingFactoryOld.eINSTANCE.createMessageToCSV
	}
}
