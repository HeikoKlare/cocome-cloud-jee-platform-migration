...
/**
 * Unification class for the class DualIterator
 */
class UnifiedDualIterator<T, E> extends MinimalEObjectImpl.Container implements DualIterator<T, E> {
	
	@Delegate
	protected var DualIterator<T, E> ecoreImplementation
	...
	def protected DualIterator<T, E> getInstance() {
		return JavaFactoryOld.eINSTANCE.createDualIterator
	}
}
