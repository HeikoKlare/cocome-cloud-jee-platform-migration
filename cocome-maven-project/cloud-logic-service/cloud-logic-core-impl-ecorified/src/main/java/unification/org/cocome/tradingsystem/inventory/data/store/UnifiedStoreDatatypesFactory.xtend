...
/**
 * Unification class for the class StoreDatatypesFactory
 */
class UnifiedStoreDatatypesFactory extends MinimalEObjectImpl.Container implements StoreDatatypesFactory {
	
	@Delegate
	protected var StoreDatatypesFactory ecoreImplementation
	...
	def protected StoreDatatypesFactory getInstance() {
		return StoreFactoryOld.eINSTANCE.createStoreDatatypesFactory
	}
}
