...
/**
 * Unification class for the class GetXMLFromBackend
 */
class UnifiedGetXMLFromBackend extends MinimalEObjectImpl.Container implements GetXMLFromBackend {
	
	@Delegate
	protected var GetXMLFromBackend ecoreImplementation
	...
	def protected GetXMLFromBackend getInstance() {
		return ConnectionFactoryOld.eINSTANCE.createGetXMLFromBackend
	}
}
