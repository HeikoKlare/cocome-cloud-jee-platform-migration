...
/**
 * Unification class for the class ProductSupplier
 */
class UnifiedProductSupplier extends MinimalEObjectImpl.Container implements ProductSupplier {
	
	@Delegate
	protected var ProductSupplier ecoreImplementation
	...
	def protected ProductSupplier getInstance() {
		return EnterpriseFactoryOld.eINSTANCE.createProductSupplier
	}
}
