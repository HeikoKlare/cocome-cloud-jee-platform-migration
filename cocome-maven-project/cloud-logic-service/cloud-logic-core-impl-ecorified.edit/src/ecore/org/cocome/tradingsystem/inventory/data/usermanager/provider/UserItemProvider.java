...
/**
 * This is the item provider adapter for a {@link ecore.org.cocome.tradingsystem.inventory.data.usermanager.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsermanagerPackage.Literals.USER__USERNAME,
				 true,
				 false,
				 false,
	...
	protected void addCredentialsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_credentials_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_credentials_feature", "_UI_User_type"),
				 UsermanagerPackage.Literals.USER__CREDENTIALS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsermanagerPackage.Literals.USER__ROLES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
